...
<div id="main">
    ...
    <form name=tradequery action=
    <c:url value="/alipay/alipayTradeQuery"/> method=post
          target="_blank">
        <div id="body2" class="tab-content" name="divcontent">
            <dl class="content">
                <dt>商户订单号 ：</dt>
                <dd>
                    <label for="outTradeNo"></label><input id="outTradeNo" name="outTradeNo"/>
                </dd>
                <hr class="one_line">
                <dt>支付宝交易号 ：</dt>
                <dd>
                    <label for="tradeNo"></label><input id="tradeNo" name="tradeNo"/>
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
                    ...
                    <span class="note-help">"购买成功页面获取: 商户订单号 ：" + BigInt(${trade_no}) + "  支付宝交易号  : " + BigInt(${trade_no})</span>
                </dd>
            </dl>
        </div>
    </form>
    <form name=traderefund action=
    <c:url value="/alipay/alipayTradeRefund"/> method=post
          target="_blank">
    ...
    <form name=traderefundquery
          action=
          <c:url value="/alipay/alipayTradeFastpayRefundQuery"/> method=post
          target="_blank">
                ...
                <dd id="btn-dd">
						<span class="new-btn-login-sp">
                            ...
                            <button class="new-btn-login" type="submit"
                                    ...
                                    onclick="alipayTradeFastpayRefundQuery()">ajax退 款 查 询</button>
						</span> <span class="note-help">商户订单号与支付宝交易号二选一，如果您点击“退款查询”按钮，即表示您同意该次的执行操作。</span>
                </dd>
            </dl>
        </div>
    </form>
    <form name=tradeclose action=
    <c:url value="/alipay/alipayTradeClose"/> method=post
          target="_blank">
...
<script language="javascript" type="text/javascript">
    $(function () {
        alert("购买成功页面获取: 商户订单号 ：" + BigInt(${trade_no}) + "  支付宝交易号  : " + BigInt(${trade_no}));
        $("#outTradeNo").val("");
        $("#tradeNo").val("");
        console.log(BigInt(${trade_no}));
        $("#outTradeNo").val(BigInt(${out_trade_no}));
        $("#tradeNo").val(BigInt(${trade_no}));
